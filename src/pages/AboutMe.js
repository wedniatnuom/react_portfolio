  ...
  <div className="d-flex flex-column align-items-center" style={{ backgroundImage: "linear-gradient(to bottom, lightblue, lightseagreen"}}>
    <div className="border rounded col-9 m-4" style={{backgroundImage: "linear-gradient(to bottom right, lightslategray, lightgray"}}>
      <div className="d-flex flex-row align-items-center">
          <img className="m-2 mr-2 rounded border border-secondary" src={ProfilePic} alt="profile pic" style={{ width: "300px", height: "400px" }}></img>
          <div className="d-flex flex-row align-items-center m-4 ml-5 rounded border border-secondary" style={{backgroundColor: "whitesmoke", fontSize: "20px"}}>
            <p className="m-2" style={{fontFamily: "georgia, serif"}}>
